...
const Footer = ({ theme }) => {
  return (
    ...
    >
        ...
        <div className="text-gray-600 dark:text-gray-400">
          ...
          <div className="flex gap-2 text-sm">
            <input
              ...
              className="w-full p-3 text-sm outline-none rounded border border-gray-300 dark:text-gray-300 dark:border-gray-600"
            />
      ...
      >
        <p>Copyright 2025 &copy; agency-ai - All Rights Reserved. </p>
